    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player_subscription', models.ManyToManyField(blank=True, related_name='_player_player_subscription_+', to='core.Player')),
            ],
        ),
        migrations.CreateModel(
            name='Position',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invitation', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.invitation')),
                ('match', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='core.match')),
                ('match_request', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.matchrequest')),
